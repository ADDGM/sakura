		...
		<div class="site-info" theme-info="Sakura v<?php echo SAKURA_VERSION; ?>">
			<div class="footertext">
				<div class="img-preload">
					<img src="<?php echo esc_url(sakura_theme_asset_url('images/wordpress-rotating-ball-o.svg')); ?>">
					<img src="<?php echo esc_url(sakura_theme_asset_url('images/disqus-preloader.svg')); ?>">
				</div>
