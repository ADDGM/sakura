		...
		<?php if(!is_user_logged_in()){ ?>
			<div class="ex-login">
				<div class="ex-login-title">
					<p><img src="<?php echo esc_url(get_template_directory_uri() . '/images/avatar.jpeg'); ?>"></p>
				</div>
				<form action="<?php echo home_url(); ?>/wp-login.php" method="post">  
					<p><input type="text" name="log" id="log" value="<?php echo esc_attr(wp_unslash($_POST['log'] ?? '')); ?>" size="25" placeholder="Name" required /></p>
