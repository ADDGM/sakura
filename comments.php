			...
			<?php
				...
				if ( ! is_user_logged_in() ) {
					$comment_fields = array(
						...
						'qq' => '<input type="text" placeholder="QQ" name="new_field_qq" id="qq" value="' . esc_attr($comment_author_url) . '" style="display:none" autocomplete="off"/><!--此栏不可见--></div>',
					);
				}
				$args = array(
						'id_form' => 'commentform',
