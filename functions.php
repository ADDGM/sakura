...
function sakura_scripts()
{
    ...
    if (sakura_live2d_is_enabled()) {
        ...
        wp_localize_script('sakura-live2d-message', 'SakuraLive2D', array(
            ...
            'messageUrl' => add_query_arg('ver', $cache_version, sakura_theme_asset_url('live2d/message.json')),
            'messages' => array(
                'viewLink' => __('Want to read <span style="color:#f6f;">{text}</span>?', 'sakura'),
                'postImage' => __('Do you like the featured image?', 'sakura'),
                'readMore' => __('Keep reading to find out more!', 'sakura'),
                'playMusic' => __('<span style="color:red;">Want to hear the songs picked for you? ♪</span>', 'sakura'),
                'searchHelp' => __('<span style="color:red;">Looking for something? Can I help?</span>', 'sakura'),
                'goHome' => __('<span style="color:red;">Shall we go back to the home page?</span>', 'sakura'),
                'menu' => __('<span style="color:red;">That is the menu button!</span>', 'sakura'),
                'avatar' => __('<span style="color:red;">Please be gentle with that!</span>', 'sakura'),
                'video' => __('<span style="color:red;">Want to watch a video?</span>', 'sakura'),
                'nextVideo' => __('<span style="color:red;">Try the next video if you like!</span>', 'sakura'),
                'social' => __('<span style="color:red;">Follow the author on social media!</span>', 'sakura'),
                'search' => __('Cannot find what you want? Try searching.', 'sakura'),
                'reward' => __('Thank you for supporting the author!', 'sakura'),
                'comments' => __('Open the comments and join the conversation!', 'sakura'),
                'commentContent' => __('Have something to say?', 'sakura'),
                'like' => __('Give this post a like!', 'sakura'),
                'share' => __('Share this post so more people can read it!', 'sakura'),
                'backToTop' => __('Back to the top!', 'sakura'),
                'privacy' => __('Check the privacy option before posting your comment.', 'sakura'),
                'author' => __('What should I call you?', 'sakura'),
                'email' => __('Your email helps us find your avatar.', 'sakura'),
                'website' => __('Where is your blog? I would like to visit!', 'sakura'),
                'writeComment' => __('Please be kind when you leave a comment.', 'sakura'),
                'emoji' => __('Would you like to pick an emoji?', 'sakura'),
                'submit' => __('Ready? Send your comment to the author!', 'sakura'),
                'morePosts' => __('There are more posts to read!', 'sakura'),
                'pagination' => __('Turn the page here!', 'sakura'),
                'friends' => __('Meet the author\'s friends!', 'sakura'),
                'previousPost' => __('Read the previous post.', 'sakura'),
                'nextPost' => __('Read the next post.', 'sakura'),
                'hide' => __('You can hide me if you wish. Hmph!', 'sakura'),
                'modelHover' => __('Hey, watch where you put that cursor!', 'sakura'),
                'modelHoverShy' => __('Y-your cursor is in the wrong place!', 'sakura'),
                'modelClick' => __('Hands off!', 'sakura'),
                'modelClickShy' => __('H-how shameless!', 'sakura'),
                'modelClickTease' => __('You tease!', 'sakura'),
                'modelClickWarning' => __('Keep that up and I will call for help!', 'sakura'),
                'modelClickHelp' => __('Help! Someone will not stop poking me!', 'sakura'),
            ),
