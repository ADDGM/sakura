...
?>
	<article class="post post-list-thumb <?php echo $class; ?>" itemscope="" itemtype="http://schema.org/BlogPosting">
		<div class="post-thumb">
			<a href="<?php the_permalink(); ?>"><img class="lazyload" src="<?php echo esc_url(sakura_theme_asset_url('images/loaders/orange.progress-bar-stripe-loader.svg')); ?>" data-src="<?php echo $post_img; ?>"></a>
		</div><!-- thumbnail-->
